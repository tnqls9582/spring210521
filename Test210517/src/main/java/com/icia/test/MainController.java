...
//	}
	...
	// /abc 라는 주소 요청이 왔을 때 abc.jsp를 출력하는 메소드 정의
	...
	// form 태그를 통해 전송된 값을 처리할 때 메소드 정의
	@RequestMapping(value="/paramtest")
	public void home3(@RequestParam("param1") String a) {
	// RequestParam 어노테이션 : 화면(jsp)로부터 전송된 파라미터에 담긴 값을 꺼내는 역할
